...
const Projects = () => {
  const projects = [
    ...
    {
      title: 'SecureComm (Cyber Security)',
      category: 'Security',
      description: 'A platform for secure communication and cyber security awareness.',
      details: 'Demonstrates common cyber threats like phishing and man-in-the-middle attacks, providing best practices for digital safety.',
      tags: ['Security', 'React', 'Communication'],
