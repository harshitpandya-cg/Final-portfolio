      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/harshitpandya-cg" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-white transition-all duration-300 hover:scale-125">
              <FaGithub size={20} />
            </a>
            <a href="https://www.linkedin.com/in/harshitpandya2911/" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-[#0077b5] transition-all duration-300 hover:scale-125">
              <FaLinkedin size={20} />
            </a>
            <a href="https://x.com/HarshitP68223" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-[#1da1f2] transition-all duration-300 hover:scale-125">
               <FaTwitter size={20} />
            </a>
            <a href="https://www.youtube.com/@harshitpandya2911" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-[#ff0000] transition-all duration-300 hover:scale-125">
              <FaYoutube size={20} />
            </a>
          </div>
