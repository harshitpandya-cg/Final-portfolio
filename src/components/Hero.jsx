    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden py-32">
      ...
      <div className="container mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-20">
        ...
        >
          ...
          >
            <a href="#projects" className="group relative px-12 py-6 rounded-full overflow-hidden bg-primary font-black text-white shadow-2xl shadow-primary/40 hover:scale-105 transition-all duration-500">
              <span className="relative z-10 flex items-center tracking-widest uppercase text-xs">
                Explore Projects
            ...
            <a 
              href="/resume.pdf" 
              download 
              className="group px-12 py-6 rounded-full glass border border-white/10 font-black tracking-widest uppercase text-xs flex items-center hover:bg-white/5 transition-all duration-300 hover:border-white/30"
            >
               <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center mr-3 group-hover:bg-primary/20 transition-all">
