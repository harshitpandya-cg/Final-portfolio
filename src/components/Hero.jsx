    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden py-32">
      ...
      <div className="container mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20">
        ...
        >
          ...
          >
            <a href="#projects" className="w-full sm:w-auto group relative px-10 py-5 rounded-2xl overflow-hidden bg-primary font-black text-white shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-1.5 transition-all duration-500 text-center">
              <span className="relative z-10 flex items-center justify-center tracking-[0.2em] uppercase text-[11px]">
                Explore Projects
                <ArrowRight className="ml-3 group-hover:translate-x-1.5 transition-transform duration-500" size={14} />
              </span>
            ...
            >
               <Eye size={14} className="mr-3 text-primary group-hover:scale-110 transition-transform" />
               View CV
            </a>
            ...
            <a 
              ...
              className="w-full sm:w-auto group px-10 py-5 rounded-2xl glass border border-white/10 font-black tracking-[0.2em] uppercase text-[10px] flex items-center justify-center hover:bg-white/10 hover:-translate-y-1 transition-all duration-500 hover:border-white/20"
            >
               <Download size={14} className="mr-3 text-secondary group-hover:scale-110 transition-transform" />
               Download CV
            </a>
          </motion.div>
        </motion.div>
